...
## 1 - Informe o total e média de Vendas por Categoria em RJ
...
## 2 - Informe o total e média de Vendas por Segmento em RJ
...
## 3 - Informe o total e média de Vendas por Vendedores em RJ
